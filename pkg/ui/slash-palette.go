...
var slashMenuItems = []SlashMenuItem{
	...
	{Number: 32, Command: "/steer", Description: "Inject real-time high-priority steering into agent thought loop"},
	{Number: 33, Command: "/queue", Description: "Enqueue prompts to execute automatically after current turn"},
	{Number: 34, Command: "/troll", Description: "Toggle harmless fake scare prank commands on/off"},
	{Number: 35, Command: "/feedback", Description: "Send feedback about mncode to the team"},
	{Number: 36, Command: "/clear", Description: "Clear terminal screen and conversation history"},
	{Number: 37, Command: "/help", Description: "Show available slash commands"},
	{Number: 38, Command: "/exit", Description: "Exit mncode assistant"},
}
