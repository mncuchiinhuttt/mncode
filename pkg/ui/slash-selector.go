...
var slashOptions = []SlashOption{
	...
	{Command: "/feedback", Description: "Send feedback about mncode to the team", Category: "General"},
	{Command: "/scan", Description: "Deep scan & prime entire codebase architecture into memory", Category: "General"},
	{Command: "/diff", Description: "View uncommitted git diffs and modified files in workspace", Category: "Git"},
	{Command: "/undo", Description: "Revert last agent turn and restore workspace files", Category: "Git"},
	{Command: "/rewind", Description: "Rewind N previous turns and conversation steps", Category: "Session"},
	{Command: "/checkpoint", Description: "Save or list manual and turn snapshots", Category: "Git"},
	{Command: "/commit", Description: "AI-assisted semantic Conventional Commit & push", Category: "Git"},
	{Command: "/test", Description: "Run project test suite automatically", Category: "Quality"},
	{Command: "/heal", Description: "Autonomous test failure analysis and self-healing loop", Category: "Quality"},
	{Command: "/review", Description: "Pre-commit security and clean code auditor", Category: "Quality"},
	{Command: "/share", Description: "Export and share session transcript to web & clipboard", Category: "Session"},
	{Command: "/pr", Description: "Create GitHub Pull Request with automated AI summary", Category: "Git"},
	{Command: "/doctor", Description: "Diagnose workspace health, toolchains, and rule limits", Category: "General"},
	{Command: "/symbol", Description: "Search codebase functions, structs, classes via AST", Category: "Search"},
	{Command: "/scratch", Description: "Open local code sandbox to evaluate test snippets", Category: "Tools"},
	{Command: "/resolve", Description: "Autonomous Git merge conflict detector & resolver", Category: "Git"},
	{Command: "/db", Description: "Database schema explorer and SQL query runner", Category: "Tools"},
	{Command: "/api", Description: "HTTP & REST API endpoint tester with latency meter", Category: "Tools"},
	{Command: "/tree", Description: "Interactive ASCII codebase file tree visualizer", Category: "General"},
	{Command: "/changelog", Description: "Synthesize release notes and update CHANGELOG.md", Category: "Git"},
	{Command: "/steer", Description: "Inject real-time high-priority steering into agent thought loop", Category: "Workflow"},
	{Command: "/queue", Description: "Enqueue prompts to execute automatically after current turn", Category: "Workflow"},
	{Command: "/troll", Description: "Toggle harmless fake scare prank commands on/off", Category: "Settings"},
	...
	{Command: "/benchmark", Description: "Autonomous micro-benchmark suite & memory/latency profiling", Category: "Quality"},
	{Command: "/security", Description: "Enterprise OWASP vulnerability scanner & auto-patcher", Category: "Security"},
	{Command: "/seed", Description: "Generate realistic localized relational mock data & seed scripts", Category: "Tools"},
