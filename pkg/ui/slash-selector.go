...
var slashOptions = []SlashOption{
	...
	{Command: "/login antigravity", Description: "Interactive login with Antigravity token", Category: "Accounts"},
	{Command: "/login codex", Description: "Interactive login with Codex/OpenAI API key", Category: "Accounts"},
